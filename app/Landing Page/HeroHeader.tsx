...
const HeroHeader = () => {
  return (
    <>
      <div className="bg-hero-image bg-cover bg-center pb-40 pt-40">
        <div className="relative mx-auto">
          {/* Call Flow Builder and other UI elements */}
          <div className="absolute top-[180px] right-0 h-9 w-36">
          ...
          <div className="absolute right-[180px] top-[-70px] h-9 w-44">
          ...
          <div className="absolute left-[175px] top-[-50px] h-9 w-36">
          ...
          <div className="absolute left-0 top-[120px] h-9 w-36">
          ...
          <div className="absolute top-[180px] left-[135px] h-9 w-36">
          ...
          {/* Main headline text */}
          <div className="text-black relative z-10 mx-auto w-[80%] justify-center self-stretch text-center font-syne text-5xl font-bold leading-[55px]">
