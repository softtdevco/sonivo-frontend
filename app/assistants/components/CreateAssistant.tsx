        ...
        <div className="inline-flex shrink grow basis-0 flex-col items-center justify-start gap-8 self-stretch">
          <div className="flex h-[125px] flex-col items-center justify-start gap-6 self-stretch">
            ...
            <div className="flex h-[61px] flex-col items-center justify-start gap-2 self-stretch">
              <div className="self-stretch text-center font-['Inter'] text-base font-semibold text-gray-600">
                Assistants
              </div>
              <div className="self-stretch text-center font-['Inter'] text-sm font-normal text-gray-500">
          ...
          <div className="inline-flex items-center justify-center gap-4">
            <div className="flex items-center justify-start gap-1.5 rounded-xl bg-[#131313] px-5 py-3">
              <div className="text-center font-['Inter'] text-base font-medium leading-[14.40px] text-white">
                Create Assistant
              </div>
            </div>
